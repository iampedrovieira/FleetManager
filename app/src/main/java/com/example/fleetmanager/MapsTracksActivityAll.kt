...
import com.example.fleetmanager.realtimeLocationAll.FirebaseDriverListener
import com.example.fleetmanager.realtimeLocationAll.FirebaseEventListenerHelper
import com.example.fleetmanager.realtimeLocationAll.MarkerCollection
import  com.example.fleetmanager.realtimeLocation.MarkerAnimationHelper
import com.google.android.gms.location.*
import com.google.android.gms.maps.GoogleMap
import com.google.android.gms.maps.SupportMapFragment
import com.google.android.gms.maps.model.LatLng
import com.google.firebase.database.FirebaseDatabase
import kotlinx.android.synthetic.main.activity_maps_track_all.*

class MapsTracksActivityAll : AppCompatActivity(), FirebaseDriverListener {
    ...
    private val databaseReference = FirebaseDatabase.getInstance("https://fleetmanagement-4bf81-default-rtdb.europe-west1.firebasedatabase.app/").reference.child(ONLINE_DRIVERS)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_maps_track_all)
        val mapFragment: SupportMapFragment = supportFragmentManager.findFragmentById(R.id.mapTracksAll) as SupportMapFragment
    ...
    override fun onDriverAdded(driver: DriverConstructor) {
    ...
    override fun onDriverRemoved(driver: DriverConstructor) {
        MarkerCollection.removeMarker(driver.driverId)
        totalOnlineDrivers.text = resources.getString(R.string.total_online_drivers).plus(" ").plus(MarkerCollection.allMarkers().size)
    }
    override fun onDriverUpdated(driver: DriverConstructor) {
